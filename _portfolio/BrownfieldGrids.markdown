...
The tool for mapping brownfield land formed part of my MSc thesis at <a href="https://www.ucl.ac.uk/bartlett/casa/">The Bartlett Centre for Advanced Spatial Analysis (CASA)</a>, University College London. The project - including code, open data, an assortment of data visualisations and the thesis itself - has been provided on <a href="https://github.com/lbuk/masters_dissertation">Github</a>.
