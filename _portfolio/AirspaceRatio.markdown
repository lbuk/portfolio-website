...
<div class="col">
	<img class="col" src="{{ site.baseurl }}/img/ar_airspace_ratio_equation_portfolio_website.png" alt="" title=""/>
</div>
...
<div class="col">
	<img class="col" src="{{ site.baseurl }}/img/afar_airspace_floor_area_ratio_equation_portfolio_website.png" alt="" title=""/>
</div>
