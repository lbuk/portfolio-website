...
<div class="col">
	<img class="col" src="{{ site.baseurl }}/img/ar_airspace_ratio_portfolio_site.png" alt="" title=""/>
</div>
...
<div class="col">
	<img class="col" src="{{ site.baseurl }}/img/afar_airspace_floor_area_ratio_portfolio_site.png" alt="" title=""/>
</div>
