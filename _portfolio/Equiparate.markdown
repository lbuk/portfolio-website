...
Urban density can be measured and interpreted in many ways. equiparate is an R package for comparing measures of density. The tool generates heatmaps to compare density abstractions. The package can be downloaded from <a href="https://github.com/lbuk/equiparate">Github</a>.
