...
equiparate is an R package for creating comparative visualisations of urban density. The tool generates multiple heatmaps to compare density measures. The package can be downloaded from <a href="https://github.com/lbuk/equiparate">Github</a>.
