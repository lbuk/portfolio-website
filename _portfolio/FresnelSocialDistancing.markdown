...
Drawing on Fresnel's circles and the <a href="https://www.liamthomasbolton.com/portfolio/FresnelMap/">Fresnel Map</a>, the effectiveness of the various social distancing rules can be compared. According to Fresnel's circles, each 'doughnut' has the same area as the central circle. In this particular example, the radius of the central circle is 1m and the successive zones have radii of 1.4m, 1.7m, 2m, 2.2m, and 2.4m (see Figure 1). Alternatively, the zones can be altered by varying the radius of the central circle. The effectiveness of different social distancing rules can be compared using these zones.
